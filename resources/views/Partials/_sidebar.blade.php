  ...
  <ul class="nav">
    ...
    <li class="nav-item sidebar-actions">
      <span class="nav-link">
        ...
        @if (!$kasLunas)
          <a href="{{ route('BayarKas') }}" class="btn btn-block btn-lg btn-gradient-primary mt-4">+ Bayar Kas</a>
        @endif
        <br>
        @if (!$donePiket && $isPiket)
          <a href="{{ route('Piket') }}" class="btn btn-block btn-lg btn-gradient-primary mt-4">+ Laporan Piket</a>
        @endif
